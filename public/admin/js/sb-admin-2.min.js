...
//     t("body, .body").toggleClass("sidebar-toggled"), console.log("clicked");
...
//     }),
//     t("body.fixed-nav .sidebar ,  .body.fixed-nav .sidebar").on(
...
document.addEventListener("DOMContentLoaded", function () {
  !(function (t) {
    "use strict";
    t("#sidebarToggle, #sidebarToggleTop").on("click", function (o) {
      // console.log("clicked, toggling sidebar checking from sb-admin-2.min.js");
